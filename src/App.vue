<template>
  <div id="app" class="m-0">
    ...
    <nav class="navbar navbar-expand-lg navbar-light bg-light">
      <router-link to="/" class="navbar-brand"><img src="@/assets/logo.png" alt="" style="height: 90px"></router-link>
      ...
      <div class="collapse navbar-collapse" id="navbarNav">
        <ul class="navbar-nav ml-auto">
          ...
          <li class="nav-item">
            <router-link v-if="isLoggedIn" to="/logout" @click.native="logout" class="nav-link">Logout</router-link>           
          </li>
          <li class="nav-item">
